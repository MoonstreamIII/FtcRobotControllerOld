...
@Autonomous(name="Auto Blue Side Right Park",group="Linear")
@Disabled
public class Auto_BlueSide_Right_JustPark extends LinearOpMode {
    ...
    private String[] commands = {"lift","wait","strafeR","forward","lift"};
    private double[] values = {0.5,0,0.7,0.7,0.5};
    private double[] times = {0,100,0,0,0};
    private int[] encodes = {150,0,5000,5000,0};
