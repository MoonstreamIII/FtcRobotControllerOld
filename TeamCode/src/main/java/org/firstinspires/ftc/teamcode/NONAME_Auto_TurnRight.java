...
@Autonomous(name="Auto Turn Right",group="Linear")
//@Disabled
public class NONAME_Auto_TurnRight extends LinearOpMode {
    ...
    private String[] commands = {"wait","posArm","forward","right","forward","spinner"};
