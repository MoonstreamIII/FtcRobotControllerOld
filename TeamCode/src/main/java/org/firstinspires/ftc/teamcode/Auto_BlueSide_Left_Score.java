...
@Autonomous(name="Auto Blue Side Left Score",group="Linear")
@Disabled
public class Auto_BlueSide_Left_Score extends LinearOpMode {
    ...
    private String[] commands = {"lift","strafeR","forward","strafeL","forward"};
    private double[] values = {0,0.7};
    private double[] times = {100,100};
