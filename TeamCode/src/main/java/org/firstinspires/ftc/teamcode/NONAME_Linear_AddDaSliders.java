...
public class NONAME_Linear_AddDaSliders extends LinearOpMode {
    ...
    private double armError=ArmRef.PowerMode.armError;
    private double tgtArmPower=ArmRef.PowerMode.tgtArmPower;
    ...
    public static double armDistMultiplier=ArmRef.PowerMode.armDistMultiplier;
    public static double armPowerLimit=ArmRef.PowerMode.armPowerLimit;
