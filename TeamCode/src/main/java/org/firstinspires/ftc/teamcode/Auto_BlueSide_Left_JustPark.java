...
@Autonomous(name="Auto Blue Side Left Park",group="Linear")
@Disabled
public class Auto_BlueSide_Left_JustPark extends LinearOpMode {
    ...
    private String[] commands = {"lift","strafeL","forward","lift"};
